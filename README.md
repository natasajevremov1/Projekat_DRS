# Avio Letovi — Flight Booking & Management System
...
- Manager: `username` / *(change password via Edit Profile)*
- User: `natasajevremov02@gmail.com` / *(change password via Edit Profile)*
